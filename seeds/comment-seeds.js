...
const commentData = [
    ...
    {
        comment_text: 'Morbi odio odio, elementum eu, interndum eu, tincidunt in, leo. Maecenas pulvinar lobortis est.',
        user_id: 6,
        post_id: 8
    },
    {
    ...
    {
        comment_text: 'Integer tincidunt ante vel ipsum. Praesent blandit lancinia erat.',
        user_id: 6,
        post_id: 12
    },
    {
    ...
    {
        comment_text: 
            'Curabitur in libero ut massa volutpat convallis. Mprbi odio odio, elementum eu, interdum eu, tincidunt in, leo.',
        user_id: 4,
        post_id: 9
    },
    {
    ...
    {
        comment_text: 'Vestibulum rutrum neque. Aenean auctor gravida sem.',
        user_id: 8,
        post_id: 2
    },
    {
    ...
    {
        comment_text: 'Mauris enim leo, rhoncus sed, vestibulum sit amet, sursus id, turpis.',
        user_id: 4,
        post_id: 11
    },
    {
    ...
    {
        comment_text: 'Cum sociis natoque penatibus et magnis dis parturient montes, nescetur ridiculus mus.',
        user_id: 4,
        post_id: 10
    },
    {
        comment_text: 'Morbi non quam nec dui luctus rotrum.',
        user_id: 3,
        post_id: 8
    },
    {
    ...
    {
        comment_text: 
            'Phasellus id sapien in sapien iaculis congue. Vivamus meyus arcu, adipiscing molestie, hendererit at, vulputate vitae, nisl.',
        user_id: 1,
        post_id: 15
    },
    {
        comment_text: 'Curabitur convallis. Duis consequat dui nec nisi volutoat eleifend.',
        user_id: 5,
        post_id: 3
    },
    {
    ...
    {
        comment_text: 'Sed amte. Vivamus tortor.',
        user_id: 7,
        post_id: 5
    },
    {
